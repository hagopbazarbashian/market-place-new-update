...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">MESSAGES Jack pops</span> </a>
                {{-- header buttons --}}
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <a href="#" class="user-name">MESSAGES Jack pops</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
...
tooltip.innerHTML = "!! If you want to save this customer, click on this star, it is necessary";
...
// Add the click event listener to the tooltip
